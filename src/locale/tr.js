export default {
  ...
  UPLOAD_URL: 'https://personel.turizmhosting.com/api/v1/upload/',
  BACKEND_URL: 'https://personel.turizmhosting.com/api/v1/',
  API_URL: 'https://personel.turizmhosting.com/api/v1/',
  SITE_URL: 'https://personel.turizmhosting.com/',
  turkish: 'Türkçe',
  german: 'Almanca',
  turkish_code: 'TR',
  german_code: 'DE',
